<div class="page-header">
	<div class="row">
		<div class="col-lg-6">
			<h3>Hasil Plagiarism Makalah</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?php echo base_url();?>/ltr/index.html">Home</a></li>
				<li class="breadcrumb-item">Forms  </li>
				<li class="breadcrumb-item active">Hasil Plagiarism Makalah</li>
			</ol>
		</div>
		<div class="col-lg-6">
			<!-- Bookmark Start-->
...
<div class="container-fluid">
	<div class="row">
			...
			<?php echo $this->session->flashdata('notif');?>
				<div class="card">
					<div class="card-header">
						<h5>Data File Makalah</h5>
						Dibawah ini adalah hasil dari check plagiatrism makalah peserta, <b>Silahkan klik refresh pada baris makalah anda.</b>
					</div>
							...
							foreach ($dataListMakalah as $key) {
								...
								<tbody>
									<tr>
										...
										<td><button class="btn btn-primary" type="button" data-original-title="Cek Status Plagiat" title="" onclick="cek('<?php echo $key["id_makalah"]; ?>')">Refresh Hasil</button>
		...
		<script type="text/javascript">
			function cek($id_similarity){
				document.location='<?php echo base_url(); ?>ControllerSuperAdmin/checkPlagiatMakalah/'+$id_similarity;
			}
		</script>