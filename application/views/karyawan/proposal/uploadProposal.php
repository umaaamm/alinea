...
<div class="container-fluid">
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>Karyawan/EditProposalKaryawan">
					<div class="modal-header">
						<h5 class="modal-title">Edit Data Proposal</h5>
						<button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
					</div>
					<div class="modal-body">
						<input type="hidden" name="id_proposal" id="id" readonly>
						...
						<div class="row">
							<label class="col-lg-12 control-label">Upload File</label>
							<label id="nmproposal" class="col-lg-12 control-label"></label>
							<div class="col-md-4 mb-3">
	...
	<script type="text/javascript">
		...
		function edit(id,jdl_mkl,unitKerja,areaID,cabang,kategoriID,nama_file_proposal){
			$('#id').val(id);
			$('#jdl_mkl').val(jdl_mkl);
			$('#areaID').val(areaID);
			$('#cabang').val(cabang);
			$('#kategoriID').val(kategoriID);
			$('#nmproposal').text(nama_file_proposal);
